window.MONITOR_DATA = {
  "schemaVersion": 1,
  "updatedAt": "2026-09-09T09:02:56+00:00",
  "project": {
    "name": "천하",
    "englishName": "TIANXIA",
    "edition": "개발 관측소",
  ...
  "cards": [
    ...
    },
    {
      ...
      "evidence": "일기토 규칙 40개, 전용 모드 흐름 14개 검사 통과. 실제 장수 모델과 근접 화면은 검토 중입니다.",
      "next": "네 장수의 모델·공격 동작을 실제 화면에서 검증하고 별도 실행 빌드 제공",
      "priority": "focus"
    },
    {
      "id": "hero_models",
      ...
      "evidence": "독립된 편집 원본과 PBR 장수 모델 제작 중. 관절 피벗 방식이며 전신 스키닝·양손 IK는 후속입니다.",
      "next": "네 모델의 실제 렌더 검토와 공격·방어·피격 동작 연결",
      "priority": "focus"
    },
    {
      "id": "models",
    ...
    },
    {
      ...
      "evidence": "원작 런처와 게임 실행을 확인했습니다. 실제 전투·캠페인 비교를 진행합니다.",
      "next": "기준 장면·프레임·세이브·모드 호환성 확인",
      "priority": "normal"
    },
    {
      "id": "animation",
