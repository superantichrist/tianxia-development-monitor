window.MONITOR_DATA = {
  "schemaVersion": 1,
  "updatedAt": "2026-09-09T08:47:41+00:00",
  "project": {
    "name": "천하",
    "englishName": "TIANXIA",
    "edition": "개발 관측소",
  ...
  "cards": [
    {
      ...
      "evidence": "모듈 266개·전투 통합 15개 검사, 1,344명 실제 화면을 확인했습니다. 최대 규모의 통합 성능·완료 영상은 별도입니다.",
      "next": "최대 병력의 렌더 ID·사망 위치·접촉 비용·전투 품질 확인",
      "priority": "focus"
    },
    {
      "id": "contact",
    ...
    },
    {
      ...
      "status": "planned",
      "milestone": "다음 우선",
      "summary": "장수 두 명의 접근·공격·방어·피격을 집중해서 플레이하는 독립 모드를 만듭니다.",
      "evidence": "새 요청으로 범위를 정한 우선 기능. 기존 전투의 일기토 신청과 구분합니다.",
      "next": "장수 선택·결투 시작·전투 조작·승패 흐름과 개인 무기 접촉 구현",
      "priority": "focus"
    },
    {
      "id": "hero_models",
      "title": "여포·관우·장비·마초 모델",
      "domain": "graphics",
      "status": "planned",
      "milestone": "다음 우선",
      "summary": "네 장수의 체형·얼굴·갑옷·무기를 구분하는 독자 모델을 우선 제작합니다.",
      "evidence": "새 제작 과제. 기존 일반 장수 모델이나 인물 데이터가 이 네 모델의 완성을 뜻하지 않습니다.",
      "next": "각 장수의 실루엣·무장·얼굴 제작, 리깅과 일기토 화면 연결",
      "priority": "focus"
    },
    {
      "id": "models",
    ...
    },
    {
      ...
      "status": "external",
      "milestone": "M04",
      "summary": "원작에서 현재 모드 구성과 그래픽·병력 규모 후보를 같은 장면으로 비교합니다.",
      "evidence": "정적 진단 완료. 실제 원작 실행을 통한 비교는 미완료입니다.",
      "next": "원작 실행 접근 후 기준 장면·프레임·세이브 호환성 확인",
      "priority": "normal"
    },
    {
      "id": "animation",
    ...
    },
    {
      ...
      "status": "in_progress",
      "milestone": "M05 병행",
      "summary": "접촉 후보와 데이터 배치를 개선하고 C++ 모듈의 비용을 비교합니다.",
      "evidence": "첫 측정의 병목을 개선 중이며 최신 모듈 CPU 수치를 검증 탭에 공개합니다. 통합 전투 FPS와 구분합니다.",
      "next": "같은 알고리즘·병력·장면으로 비용과 기능 결과 비교",
      "priority": "normal"
    },
    {
      "id": "engine",
      ...
      "status": "in_progress",
      "milestone": "매 단계",
      "summary": "Godot 개선, 다른 엔진, 전용 모듈, 원작 모드 경로를 단계마다 비교합니다.",
      "evidence": "현재 경로는 Godot와 Blender. 다른 엔진의 우위를 아직 측정하지 않았습니다.",
      "next": "기능·그래픽 효과, 제작 비용, 호환성과 성능을 함께 판단",
      "priority": "normal"
    },
    {
      "id": "replay",
  ...
  "parity": [
    {
      "area": "캠페인·경제",
      "domain": "campaign",
      "current": "8세력·30도시, 세금·식량·민심·건설·계절",
      "gap": "전체 지도·시작 연도·세력 콘텐츠, 복잡한 자원·인구 계층",
      "next": "연속 3D 지형과 군대 표시",
      "level": "기반 구현"
    },
    {
      "area": "군대·장수",
      "domain": "campaign",
      "current": "복수 군대, 모병·보충·행군, 장수 26명 데이터",
      "gap": "수행 부대, 관계·가족·장비·직위·세밀한 보급",
      "next": "지도 위 장수·깃발과 군대 이동",
      "level": "기반 구현"
    },
    {
      "area": "외교·개혁",
    ...
    },
    {
      "area": "개별 병사 전투",
      "domain": "battle",
      "current": "개인 위치·속도·HP·접촉·공격 모듈과 통합 작업",
      "gap": "전선 점유·아군 비관통·정교한 무기 접촉·규모 성능",
      "next": "실제 전투 연결과 수치·영상 검증",
      "level": "개발 중"
    },
    {
      "area": "전술·AI",
    ...
    },
    {
      "area": "원작 모드·튜닝",
      "domain": "modding",
      "current": "공식 도구·경로·스키마·분리 진단·후보 프로필",
      "gap": "실제 원작 플레이·세이브·모드 조합 호환성 확인",
      "next": "동일 장면 기준 비교",
      "level": "외부 검증 대기"
    }
  ],
  "milestones": [
    ...
    },
    {
      ...
      "title": "원작 모드·튜닝 비교",
      "status": "external",
      "description": "도구와 정적 진단 완료 · 원작 플레이 확인 대기",
      "checks": {},
      "videoVerified": false
    },
    {
      ...
      "title": "개별 교전 + 3D 캠페인",
      "status": "in_progress",
      "description": "개인 이동·접촉·타격, 지형과 지도 위 군대",
      "checks": {},
      "videoVerified": false
    },
    {
  ...
  "physicsBenchmark": {
    "agents": 25664,
    "contact_median_ms": 17.791,
    "contact_p99_ms": 20.083,
    "idle_median_ms": 0.933,
  ...
  "evidencePolicy": [
    ...
    "M05는 첫 모듈 검사와 통합·규모 성능·플레이 검증을 구분합니다.",
